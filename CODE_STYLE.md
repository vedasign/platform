# VedaSign Code Style Guide

This document captures the code style, patterns, and conventions used in the VedaSign codebase. It covers both enforceable rules and subjective "taste" elements that make our code consistent and maintainable.
