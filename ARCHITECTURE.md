# VedaSign Architecture

This document provides a high-level overview of the VedaSign codebase to help humans and agents understand how the application is structured.

## Overview

VedaSign is an open-source document signing platform built as a **monorepo** using npm workspaces and Turborepo. The application enables users to create, send, and sign documents electronically.
