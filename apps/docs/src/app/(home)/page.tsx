...
export const metadata: Metadata = {
  title: 'VedaSign Docs',
  description:
    'The official documentation for VedaSign, the open-source document signing platform. Send documents for signatures, integrate with the API, or self-host with full control.',
};
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="mb-16 pt-6 text-center">
        <h1 className="mb-4 font-bold text-4xl tracking-tight">VedaSign Documentation</h1>
      ...
      <div className="mb-16 grid gap-4 md:grid-cols-3">
        ...
        >
          ...
          <p className="mb-4 flex-1 text-fd-muted-foreground text-sm">
            Deploy your own VedaSign instance with Docker, Kubernetes, or Railway.
          </p>
      ...
      <div className="rounded-xl border bg-gradient-to-r from-fd-primary/5 to-fd-primary/10 p-8 text-center">
        ...
        <p className="mb-6 text-fd-muted-foreground text-sm">
          VedaSign is open source. Contribute, ask questions, or share feedback.
        </p>
        <div className="flex flex-wrap justify-center gap-3">
          <a
            href="https://github.com/documenso/documenso"
          ...
          <a
            href="https://app.vedasign.uk/signup"
