...
This document defines the writing conventions for VedaSign documentation.
...
1. **Users** - People using the VedaSign web application to send and sign documents
2. **Developers** - Building integrations with the API or SDKs
3. **Self-hosters** - Running their own VedaSign instance
